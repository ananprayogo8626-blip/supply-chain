...
class PortImport extends Command
{
    ...
    protected $description = 'Import data pelabuhan dunia (World Port Index) untuk negara yang terdaftar';
    ...
    public function handle()
    {
        ...
        foreach ($portsData as $code => $ports) {
            ...
            if (!$country) {
                // Try finding by code case-insensitive or name-match if code was not cca2
                continue;
            }
            ...
            foreach ($ports as $port) {
                ...
                // Random status selection for logistics reality (Target 2)
        ...
        // Add some random ports for other countries in database if needed, but the main ones are fine
        $this->info("Berhasil mengimpor {$importedCount} data pelabuhan dunia.");
        $this->info('=============================================');
