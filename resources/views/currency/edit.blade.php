                ...
                <form action="{{ route('currency.update',$currency->id) }}" method="POST">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text"
                                   name="base_currency"
                                   value="{{ old('base_currency',$currency->base_currency) }}"
                                   class="w-full border rounded p-2">
                        ...
                        <div>
                            ...
                            <input type="number"
                                   ...
                                   value="{{ old('change_percentage',$currency->change_percentage) }}"
                                   class="w-full border rounded p-2">
                        ...
                        <div>
                            ...
                            <input type="datetime-local"
                                   name="last_updated"
                                   value="{{ $currency->last_updated ? $currency->last_updated->format('Y-m-d\TH:i') : '' }}"
                                   class="w-full border rounded p-2">
