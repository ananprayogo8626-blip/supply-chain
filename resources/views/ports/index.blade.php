<x-app-layout>
    ...
    >
        ...
        <a href="{{ route('ports.export-csv') }}" class="sg-btn sg-btn-sm sg-btn-teal">
            <i data-lucide="download" class="w-4 h-4"></i>
            Export CSV
        </a>
        <a href="{{ route('ports.export-pdf') }}" class="sg-btn sg-btn-sm sg-btn-secondary" target="_blank">
    ...
    <div id="import-section" class="sg-data-card" style="margin-bottom:20px; padding:16px;">
        <h3 style="font-size:14px; font-weight:600; color:var(--sg-text-primary); margin:0 0 10px 0;">Import Ports from CSV</h3>
        <form action="{{ route('ports.import-csv') }}" method="POST" enctype="multipart/form-data" style="display:flex; gap:12px; align-items:center; flex-wrap:wrap;">
            @csrf
